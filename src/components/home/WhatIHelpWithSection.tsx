		...
		<section className="max-w-6xl mx-auto px-4 py-24">
			<div className="max-w-3xl">
				...
				<p className="mt-4 text-gray-600">
					This is how I typically help early-stage founders, startups, and
					small businesses move faster and ship with confidence.
				</p>
				...
				<ul className="mt-10 space-y-4 text-lg list-disc pl-6">
					...
					<li>
						Cleaning up codebases so teams can move faster with confidence
					</li>
				</ul>
			</div>
		</section>
