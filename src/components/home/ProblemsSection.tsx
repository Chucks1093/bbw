		...
		<section className="max-w-6xl mx-auto px-4 py-24">
			<div className="max-w-3xl">
				...
				<p className="mt-4 text-gray-600 font-inter">
					These are common issues I see in early-stage products and growing
					businesses that already have users but struggle to move forward.
				</p>
				...
				<ul className="mt-10 space-y-4 text-lg list-disc pl-6">
					...
					<li>Engineers avoid touching certain parts of the codebase</li>
					<li>
						Users complain about slowness or rough edges in the experience
					</li>
					<li>
